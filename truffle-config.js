...
module.exports = {
  ...
  networks: {
    ...
    ropsten: {
      provider: function() {
      return new HDWalletProvider(privateKey, "https://ropsten.infura.io/v3/26763e533f734041b01ddfc8c90d8824")
     },
      network_id: '3',
      websockets: true,
      gas: 8000000,
     ...
     rinkeby: {
      provider: function() {
      return new HDWalletProvider(privateKey, "https://rinkeby.infura.io/v3/26763e533f734041b01ddfc8c90d8824")
     },
      network_id: '4',
      websockets: true,
      gas: 6000000,
